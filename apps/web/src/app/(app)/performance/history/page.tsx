    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden p-6">
      <div className="max-w-5xl mx-auto w-full">
        <header className="mb-8">
          <h1 className="text-2xl font-black text-foreground mb-2">Audit History</h1>
          <p className="text-sm text-muted-foreground">
            Track your performance scores and grades over time.
          </p>
        </header>
        ...
        {isLoading ? (
          ...
          <div className="text-center p-12 border rounded-xl bg-card">
            ...
            <p className="font-semibold">No audit history found</p>
            <p className="text-sm text-muted-foreground">Run your first performance audit to see it here.</p>
          </div>
        ) : (
                ...
                {history.map((audit, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className={cn("inline-flex items-center justify-center w-8 h-8 rounded font-black border", getGradeColor(audit.performance_score))}>
