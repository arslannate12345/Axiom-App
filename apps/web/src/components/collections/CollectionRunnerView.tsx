    ...
    >
      <button onClick={() => setExpanded(!expanded)} className="w-full text-left p-4">
        <div className="flex items-center gap-3">
          {/* Method badge */}
          <span
            className="text-[12px] font-bold w-12 shrink-0"
        ...
        {expanded && (
          <div className="mt-3 pt-3 border-t border-card space-y-2">
            <div className="text-[12px] font-mono text-muted-foreground break-all">{step.url}</div>
            {step.statusCode && (
            ...
            {step.assertionFailures && step.assertionFailures.length > 0 && (
              <div className="bg-[rgba(239,68,68,0.1)] border border-[rgba(239,68,68,0.2)] p-2 rounded text-[12px]">
            ...
            {step.extractions && Object.keys(step.extractions).length > 0 && (
              <div className="bg-[rgba(16,185,129,0.1)] border border-[rgba(16,185,129,0.2)] p-2 rounded text-[12px]">
